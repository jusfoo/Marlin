...
#define STRING_CONFIG_H_AUTHOR "(Marginally Clever, Makelangelo 5 Huge)" // Who made the changes.
...
#define POLARGRAPH
  ...
  #define HYPOTENEUSE_LENGTH_AT_HOME_POSITION 2035.0
...
#define X_BED_SIZE 1366 // 650+716
