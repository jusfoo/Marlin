...
#define STRING_CONFIG_H_AUTHOR "(Sixi3, Marginally Clever Robots)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Robot Arm"
...
#endif
#if LINEAR_AXES >= 6
  #define AXIS6_NAME 'W' // :['A', 'B', 'C', 'U', 'V', 'W']
#endif
 ...
 */
// 70:1 gearbox, 54:20 belt ratio, 200 steps per turn:
// 70*(54/20)*(200/360)=105
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10, 10, 10, 10, 10, 10 }
