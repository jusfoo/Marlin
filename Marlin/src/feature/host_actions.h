...
class HostUI {
  ...
  static void action(FSTR_P const fstr, const bool eol=true);
    ...
    static void prompt_plus(const bool pgm, FSTR_P const ptype, char * const str, const char extra_char='\0');
    ...
    static void prompt_plus(FSTR_P const ptype, char * const cstr, const char extra_char='\0') {
    ...
    static void prompt_begin(const PromptReason reason, char * const cstr, const char extra_char='\0');
    static void prompt_end();

    static void prompt_button(FSTR_P const fstr);
    static void prompt_button(char * const cstr);

    static void prompt_do(const PromptReason reason, FSTR_P const pstr, FSTR_P const btn1=nullptr, FSTR_P const btn2=nullptr);
    static void prompt_do(const PromptReason reason, char * const cstr, FSTR_P const btn1=nullptr, FSTR_P const btn2=nullptr);
    ...
    static void prompt_do(const PromptReason reason, char * const cstr, const char extra_char, FSTR_P const btn1=nullptr, FSTR_P const btn2=nullptr);
